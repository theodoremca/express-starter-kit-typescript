...
exports.updateAuthUserService = exports.authUserService = exports.verifyOTPService = exports.createNewOTP = exports.createOrGetUserPhoneAuth = exports.login = void 0;
...
const login = (email, password) => {
    return new Promise((resolve, reject) => {
        user_model_1.default.findOne({ email }).then((response) => {
            ...
            if (bcrypt_1.default.compareSync(password, response === null || response === void 0 ? void 0 : response.password)) {
