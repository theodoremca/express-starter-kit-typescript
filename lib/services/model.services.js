...
exports.updateService = exports.destroyService = exports.createService = exports.showService = exports.customService = exports.indexService = void 0;
...
const customService = (Model, query) => {
    return new Promise((resolve, reject) => {
        Model.find(query)
            .then((response) => {
            resolve(response);
